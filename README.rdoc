...
You can also have a custom, user-specified message embedded in the email (after adding custom_message to attr_accessible):

  User.invite!(:email => "new_user@example.com", :name => "John Doe", :custom_message => "Hey John, you're going to love this! Say hi to the dog.")
